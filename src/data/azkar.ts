...
export const azkar: Zikr[] = [
  {
    id: 1,
    count: 1,
    intro: "أَعُوذُ بِاللهِ مِنْ الشَّيْطَانِ الرَّجِيمِ",
    ...
    audio: `${audioBase}/audio/75.mp3`,
  },
  {
    id: 2,
    count: 3,
    intro: "بِسْمِ اللهِ الرَّحْمنِ الرَّحِيم",
    ...
    audio: "https://download.quranicaudio.com/quran/mishaari_raashid_al_3afaasee/112.mp3",
  },
  {
    id: 3,
    count: 3,
    ...
    source: "سورة الفلق",
    audio: "https://download.quranicaudio.com/quran/mishaari_raashid_al_3afaasee/113.mp3",
  },
  {
    id: 4,
    count: 3,
  ...
  },
  {
    ...
    audio: `${audioBase}/audio/250.mp3`,
  },
  {
    id: 26,
    count: 3,
    text: "يَا رَبِّ , لَكَ الْحَمْدُ كَمَا يَنْبَغِي لِجَلَالِ وَجْهِكَ , وَلِعَظِيمِ سُلْطَانِكَ.",
    audio: `https://translate.google.com/translate_tts?ie=UTF-8&tl=ar&client=tw-ob&q=${encodeURIComponent("يا رب لك الحمد كما ينبغي لجلال وجهك ولعظيم سلطانك")}`,
  },
  {
    id: 27,
    count: 1,
  ...
  },
  {
    ...
    virtue: "ذكر طيب.",
    audio: `https://translate.google.com/translate_tts?ie=UTF-8&tl=ar&client=tw-ob&q=${encodeURIComponent("اللهم أنت ربي لا إله إلا أنت عليك توكلت وأنت رب العرش العظيم")}`,
  },
  {
    id: 29,
    count: 100,
  ...
  },
  {
    ...
    audio: `${audioBase}/audio/91.mp3`,
  },
  {
    id: 31,
    count: 100,
    text: "أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ.",
    virtue: "من لزم الاستغفار جعل الله له من كل ضيق مخرجا ومن كل هم فرجا ورزقه من حيث لا يحتسب.",
    audio: `${audioBase}/audio/96.mp3`,
  },
];
